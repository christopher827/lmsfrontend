...
import {HomeOutlinedIcon,ArrowForwardIosIcon,ArrowBackIosIcon,PeopleOutlinedIcon,ReceiptOutlinedIcon,BarChartOutlinedIcon,MapOutlinedIcon,GroupsIcon,OndemandVideoIcon,VideoCallIcon,WebIcon,QuizIcon,WysiwgIcon,ManageHistoryIcon,SettingsIcon,ExitToAppIcon} from "./Icon"
...
const AdminSidebar =()=>{
    ...
    const [selected,setSelected]=useState("Dashoboard")
...
color:"#6870fa !important"
  ...
  >
<ProSidebar collapsed={isCollapsed} style={{position:"fixed", top:0, left:0}}>
...
<Image alt="profile-user" width={100} height={100} src={user.avatar? user.avatar.url : avatarDefault} style={{cursor:"pointer", borderRadius:"50%",border:"3px solid #5b6fe6"}}/>
</Box>
...
<Typography variant="h5" sx={{m: "15px 0 5px 25px"}} className="!text-[18px] text-black dark:text-[#fffffc1] capitalize !font-[400]">
{!isCollapsed && "Data"}
</Typography>
...
<Item title="Categories" to="/admin/categories" icon={<WysiwgIcon/>} selected={selected} setSelected={setSelected}/>
<Typography variant="h5" sx={{m: "15px 0 5px 25px"}} className="!text-[18px] text-black dark:text-[#fffffc1] capitalize !font-[400]">
...
<Item title="Logout"  to="/admin/settings" icon={<ExitToAppIcon/>} selected={selected} setSelected={setSelected}/>
